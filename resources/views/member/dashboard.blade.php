...
<div class="container mt-5 ">
    <div class="pt-5 text-center row row-cols-1 row-cols-lg-2 row-cols-xl-4">
            ...
            <div class="card radius-15 h-100">
                <div class="text-center card-body">
                    <div class="p-4 radius-15">
                        ...
                        <div class="d-grid"> <a href="{{ route('member.bookDetails.view', $book->slug) }}" class="btn btn-info radius-15">Read</a>
                        </div>
                    </div>
                </div>
            </div>
