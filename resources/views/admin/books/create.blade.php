...
@section('current_page', 'Add new book')
                        ...
                        <div class="card-body">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="title" type="text"
                                            ...
                                            id="@error('title') inputError @enderror" placeholder="Enter Book Title" value="{{ old('title') }}">
                                        @error('title')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="author" type="text"
                                            ...
                                            id="@error('author') inputError @enderror" placeholder="Enter Book Author" value="{{ old('author') }}">
                                        @error('author')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="publisher" type="text"
                                            ...
                                            placeholder="Enter Book Publisher" value="{{ old('publisher') }}">
                                        @error('title')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="language" type="text"
                                            ...
                                            id="@error('language') inputError @enderror" placeholder="Enter Book Language" value="{{ old('language') }}">
                                        @error('language')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="isbn" type="text"
                                            ...
                                            id="@error('isbn') inputError @enderror" placeholder="Enter Book isbn number" value="{{ old('isbn') }}">
                                        @error('isbn')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="col-form-label" for="@error('total_pages') inputError @enderror">
                                            @error('total_pages') <i class="text-danger far fa-times-circle"></i>@enderror
                                        ...
                                        <input name="total_pages" type="text"
                                            ...
                                            placeholder="Enter Total Number of Pages" value="{{ old('total_pages') }}">
                                        @error('total_pages')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="col-form-label" for="@error('category_id') inputError @enderror">
                                            @error('category_id') <i class="text-danger far fa-times-circle"></i>@enderror
                                            Select Book Category
                                        </label>
                                        <select  class="form-control @error('category_id') is-invalid @enderror" name="category_id" id="@error('category_id') inputError @enderror">
                                            <option value="" disabled selected>Select category</option>
                                            @if($categories->count())
                                                @foreach ($categories as $category)
                                                    <option value="{{ $category->id }}">{{ Str::title($category->category) }}</option>
                                                @endforeach
                                            @else
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <select  class="form-control @error('genre_id') is-invalid @enderror" name="genre_id" id="@error('genre_id') inputError @enderror">
                                            <option value="" disabled selected>Select Genre</option>
                                            @if($genres->count())
                                                @foreach ($genres as $genre)
                                                    <option value="{{ $genre->id }}">{{ Str::title($genre->genre) }}</option>
                                                @endforeach
                                            @else
                                                <option value="" disabled>Not Available</option>
                                            @endif
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="col-form-label" for="@error('publication_date') inputError @enderror">
                                            @error('publication_date') <i class="text-danger far fa-times-circle"></i>@enderror
                                            Publication Date
                                        </label>
                                        <input name="publication_date" type="date"
                                            class="form-control @error('publication_date') is-invalid @enderror"
                                            id="@error('publication_date') inputError @enderror"
                                            placeholder="Publication date" value="{{ old('publication_date') }}">
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label>Select Book Tags <small class="text-info">(minimun 2)</small></label>
                                        <select name="tag_id[]" class="select2 form-control @error('tag_id') is-invalid @enderror" multiple="multiple" data-placeholder="Select book tags"
                                            style="width: 100%;" value="{{ old('tag_id[]') }}">
                                            @foreach ($tags as $tag)
                                                <option value="{{ $tag->id }}">{{ Str::title($tag->tag) }}</option>
                                            @endforeach
                                        </select>
                                        @error('tag_id')
                                        <span class="is-invalid">{{ $message }}</span>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        <label class="col-form-label" for="@error('file_format') inputError @enderror">
                                            @error('file_format') <i class="text-danger far fa-times-circle"></i>@enderror
                                            File Type
                                        </label>
                                        <input name="file_format" type="text"
                                            class="form-control @error('file_format') is-invalid @enderror"
                                            id="@error('file_format') inputError @enderror"
                                            placeholder="File Format" value="{{ old('file_format') }}">
                                        @error('file_format')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input name="file_url" type="url"
                                            ...
                                            id="@error('file_url') inputError @enderror"
                                            placeholder="File Format" value="{{ old('file_url') }}">
                                        @error('file_url')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input onchange="previewImage(this)" name="thumbnail" type="file"
                                            ...
                                            id="@error('thumbnail') inputError @enderror"
                                            placeholder="File Format" value="{{ old('thumbnail') }}" value="{{ old('thumbnail') }}">
                                        @error('thumbnail')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6 mx-auto">
                                    <img src="{{ asset('no_image.jpg') }}" alt="" class="thumbnail-preview img-fluid img-responsive w-25">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 mb-3">
                                    ...
                                    <textarea
                                        ...
                                        name="description"  id="summernote" cols="30" rows="10" value="{{ old('description') }}"></textarea>
                                        @error('description')
                                        <span class="is-invalid">{{ $message }}</span>
                                        @enderror
                                </div>
