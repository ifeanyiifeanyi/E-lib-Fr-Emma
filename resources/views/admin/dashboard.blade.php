      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Genre</span>
              <span class="info-box-number">{{ $genre }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-12 col-sm-6 col-md-3">
          <div class="info-box mb-3">
            ...
            <div class="info-box-content">
              <span class="info-box-text">Activated Codes</span>
              <span class="info-box-number">{{ $activeCodes }}</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
